...
function HomePageNav() {
    return(
        <div className="navigation-wrapper w-18 h-full text-white flex flex-col align-items-center">
            <div className="navigation-bar-container h-full bg-teal-800 text-white flex flex-col">
                <nav className="navigation-bar h-full flex flex-col justify-between">
                    <div className="sup-menu w-full h-1/2 bg-violet-500 flex flex-col py-10">
                        <button className="w-15 h-15 bg-transparent">
                            <svg className="h-10 w-8" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100"
                                 viewBox="0 0 48 48">
                                <path
