        ...
        <div className="home-main w-full h-full">
            <div className="home-body w-full h-full">
                <div className="home-content w-full h-full flex flex-row justify-center items-center">
                    <div className="top-content recent-summary absolute">
                        <div className="indicator">
                            <h3 className="text-white"> Recent Projects </h3>
                        </div>
                        <div className="recent-projects">
                            <div className="aproject w-60 p-8 bg-[#444] border-2 border-teal-800 flex flex-col justify-center items-center rounded-lg">
                                <a href="/{project-id}" className="flex flex-col justify-center items-center">
                                    ...
                                    <div className="doc-metadata text-white">
